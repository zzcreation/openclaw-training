...
| 产品 | 厂商 | 特点 | 定位 |
|:-----|:----:|:-----|:-----|
| **QClaw** | 腾讯电脑管家 | 微信/QQ接入，桌面级Agent | 个人AI助手 |
| **WorkBuddy** | 腾讯 | 企业微信接入，全场景覆盖 | 工作小伙伴 |
| **CoPaw** | 阿里云 | 开源、本地部署、钉钉/飞书原生 | OpenClaw平替 |
| **LobsterAI** | 网易有道 | 7×24小时待命、16种内置技能 | 有道龙虾 |
| **纳米AI** | 360 | 多模型聚合、MCP工具箱 | 超级搜索智能体 |
